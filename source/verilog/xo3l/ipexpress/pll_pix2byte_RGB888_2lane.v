...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n pll_pix2byte_RGB888_2lane -lang verilog -synth synplify -arch xo3c00a -type pll -fin 75 -fclkop 450 -fclkop_tol 0.0 -fclkos 450 -fclkos_tol 0.0 -fclkos2 112.5 -fclkos2_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 90 -trims_r -phases2 0 -phase_cntl STATIC -rst -fb_mode 1 -lock  */
/* Fri Feb 18 16:30:04 2022 */


`timescale 1 ns / 1 ps
module pll_pix2byte_RGB888_2lane (CLKI, RST, CLKOP, CLKOS, CLKOS2, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    input wire RST;
    output wire CLKOP;
    output wire CLKOS;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOS2="112.500000" */
             /* synthesis FREQUENCY_PIN_CLKOS="450.000000" */
             /* synthesis FREQUENCY_PIN_CLKOP="450.000000" */
             /* synthesis FREQUENCY_PIN_CLKI="75.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS2 112.500000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 450.000000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 450.000000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKI 75.000000

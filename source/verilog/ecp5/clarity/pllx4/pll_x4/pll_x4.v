...
/* Module Version: 5.6 */
/* C:\lscc\diamond\3.3_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_x4 -lang verilog -synth synplify -bus_exp 7 -bb -arch sa5p00m -type pll -fin 75 -fclkop 300 -fclkop_tol 0.0 -fclkos 300 -fclkos_tol 0.0 -phases 90 -phase_cntl STATIC -rst -lock -fb_mode 1 -fdc D:/DESKTOP/RD_WORK/rd1184/check1/source/verilog/ecp5/clarity/pllx4/pll_x4/pll_x4.fdc  */
/* Fri Dec 26 18:04:01 2014 */


`timescale 1 ns / 1 ps
module pll_x4 (CLKI, RST, CLKOP, CLKOS, LOCK)/* synthesis syn_noprune=1 *//* synthesis NGD_DRC_MASK=1 */;// exemplar attribute pll_x4 dont_touch true 
    input wire CLKI;
    input wire RST;
    output wire CLKOP;
    output wire CLKOS;

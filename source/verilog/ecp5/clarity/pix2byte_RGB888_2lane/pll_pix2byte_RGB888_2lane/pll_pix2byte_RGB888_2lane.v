...
/* Module Version: 5.6 */
/* C:\lscc\diamond\3.3_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_pix2byte_RGB888_2lane -lang verilog -synth synplify -bus_exp 7 -bb -arch sa5p00m -type pll -fin 50 -fclkop 300 -fclkop_tol 0.0 -fclkos 300 -fclkos_tol 0.0 -phases 90 -fclkos2 75 -fclkos2_tol 0.0 -phases2 0 -phase_cntl STATIC -rst -lock -fb_mode 1 -fdc D:/DESKTOP/RD_WORK/rd1184/rd1184/source/verilog/ipexpress/ecp5/pix2byte_RGB888_2lane/pll_pix2byte_RGB888_2lane/pll_pix2byte_RGB888_2lane.fdc  */
/* Sun Dec 21 21:19:51 2014 */


`timescale 1 ns / 1 ps
module pll_pix2byte_RGB888_2lane (CLKI, RST, CLKOP, CLKOS, CLKOS2, LOCK)/* synthesis syn_noprune=1 *//* synthesis NGD_DRC_MASK=1 */;// exemplar attribute pll_pix2byte_RGB888_2lane dont_touch true 
    input wire CLKI;
    input wire RST;
    output wire CLKOP;
    output wire CLKOS;

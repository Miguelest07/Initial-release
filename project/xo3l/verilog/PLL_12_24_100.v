...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n PLL_12_24_100 -lang verilog -synth synplify -arch xo3c00a -type pll -fin 12 -fclkop 24 -fclkop_tol 0.0 -fclkos 100 -fclkos_tol 0.0 -fclkos2 20 -fclkos2_tol 0.0 -fclkos3 75 -fclkos3_tol 2.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phases2 0 -phases3 0 -phase_cntl STATIC -fb_mode 1  */
/* Fri Feb 18 16:32:02 2022 */


`timescale 1 ns / 1 ps
module PLL_12_24_100 (CLKI, CLKOP, CLKOS, CLKOS2, CLKOS3)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
    output wire CLKOS2;
    ...
    defparam PLLInst_0.CLKOS3_CPHASE = 7 ;
    ...
    defparam PLLInst_0.CLKOS3_DIV = 8 ;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO3(), .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOS3="75.000000" */
             /* synthesis FREQUENCY_PIN_CLKOS2="20.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS3 75.000000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS2 20.000000
